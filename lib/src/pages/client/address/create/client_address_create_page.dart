...
import 'package:xona_eats/src/pages/client/address/create/client_address_create_controller.dart';
...
class _ClientAddressCreatePageState extends State<ClientAddressCreatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [_textCompleteData(), _textFieldAddress(), _textFieldNeighborhood(), _textFieldRefPoint()],
      ),
    );
  }
