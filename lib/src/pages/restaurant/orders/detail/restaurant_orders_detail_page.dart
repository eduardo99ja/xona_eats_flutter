...
import 'package:xona_eats/src/pages/restaurant/orders/detail/restaurant_orders_detail_controller.dart';
import 'package:xona_eats/src/utils/my_colors.dart';
import 'package:xona_eats/src/utils/relative_time_util.dart';
import 'package:xona_eats/src/widgets/no_data_widget.dart';
  ...
  Widget _textDescription() {
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(fontStyle: FontStyle.italic, color: MyColors.primaryColor, fontSize: 16),
      ),
    );
  }
                ...
                child: DropdownButton(
                  ...
                  onChanged: (option) {
                    setState(() {
                      ...
                      _con.idDelivery = option as String; // ESTABLECIENDO EL VALOR SELECCIONADO
                    });
                  },
                ),
              )
